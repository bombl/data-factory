...
public class DataSourceConfiguration {
    ...
    public DataBaseProperties dataBaseProperties(@Value("${df.database.dialect:h2}") final String dialect,
                                                 @Value("${df.database.init_script:script/h2/schema.sql}") final String initScript,
                                                 @Value("${df.database.init_enable:true}") final Boolean initEnable) {
