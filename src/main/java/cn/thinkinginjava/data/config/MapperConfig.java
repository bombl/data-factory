...
import cn.thinkinginjava.data.mybatis.OracleSQLPrepareInterceptor;
import cn.thinkinginjava.data.mybatis.OracleSQLUpdateInterceptor;
...
public class MapperConfig {
     ...
     */
    @Configuration
    @ConditionalOnProperty(name = "df.database.dialect", havingValue = "oracle")
